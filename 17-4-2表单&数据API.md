...
## 应用举例
### API & 订单管理
在启辰云中建立了一个订单表单，用于统计订单信息。销售渠道一般分为线上商城销售和线下销售，线下销售通常需要销售手动在启辰云中录入订单。但是线上渠道用户自主下单后会生成一个订单，此时这个订单可以通过`新增单条数据API接口`直接在启辰云中生成一条订单记录，这样我们就不需要一个人专门把网上的订单一条条手动录入启辰云。手动录入不仅工作量很大，而且容易出错。

### API & 项目管理
当使用启辰云做项目管理流程控制时，一般财务收款都是有单独的一套系统，此时可以通过`修改单条数据API接口`将财务软件中的收款信息推送到启辰云来，从而修改对应的项目信息。
...
<table width="1323" style="width: 828px;">
    ...
    <tbody>
        ...
        <tr style="height:162px">
            ...
            <td width="468" style="">
                [ { &quot;name&quot;: &quot;接口.pdf&quot;, &quot;size&quot;: 37602, &quot;mime&quot;: &quot;application/pdf&quot;, &quot;url&quot;: &quot;https://qiniu.baibaoyun.com/FvXfzy2nqPP12YP5cTeH6bUVp2&quot; }, { &quot;name&quot;: &quot;启辰云.pdf&quot;, &quot;size&quot;: 37602, &quot;mime&quot;: &quot;application/pdf&quot;, &quot;url&quot;: &quot;https://qiniu.baibaoyun.com/FvXfzy2nqPP12YP5cTeH6X4Vp2&quot; } ]
            </td>
            <td width="266" style="">
                数据中包含的url为附件链接
            </td>
        ...
        <tr style="height:47px">
            ...
            <td width="266" style="">
                成员信息中_id表示启辰云中的用户id；name表示用户昵称
            </td>
        </tr>
        <tr style="height:47px">
            <td width="160" style="">
